...
namespace SaleDeedRegistry.Console
{
    public class Supervisor : BaseActor
    {
        ...
        public ReceiptResponse InitApplication()
        {
            ...
            // Init Application
            var response = saleRegistryFacade.Init(requestObject).Result;
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                if (commandResponse.success)
                {
                    ...
                    receiptResponce = saleRegistryFacade.TryReceiptResponse(commandResponse.transactionId);
        ...
        /// </summary>
        /// <returns>ReceiptResponse</returns>
        public ReceiptResponse StartTheReviewProcess()
        {
            ReceiptResponse receiptResponce = null;
            ...
            var response = saleRegistryFacade.StartReview(requestObject).Result;
        ...
        /// </summary>
        /// <returns>ReceiptResponse</returns>
        public ReceiptResponse CompleteTheReviewProcess()
        {
            ReceiptResponse receiptResponce = null;
            ...
            var response = saleRegistryFacade.CompleteReview(requestObject).Result;
        ...
        /// </summary>
        /// <returns>ReceiptResponse</returns>
        public ReceiptResponse TransferOwnership(string seller, string buyer)
        {
            ReceiptResponse receiptResponce = null;
            ...
            var ownershipResponse = saleRegistryFacade.TransferOwnership(transferOwnershipEntity).Result;
